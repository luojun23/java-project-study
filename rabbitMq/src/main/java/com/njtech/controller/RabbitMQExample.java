...
public class RabbitMQExample {
    ...
    private static void testPutMessage() {
        ...
        try {
            ...
            /*参数1：交换机名称
            参数2：交换机类型 direct定向, fanout广播，发送消息到每一个与之绑定队列, topic通配符方式, headers
            参数3：是否持久化
            参数4：是否自动删除
            参数5：交换机参数*/
            ...
            channel.queueBind("test_queue1", "test_fanout", "");
            channel.queueBind("test_queue2", "test_fanout", "");
...
*/
             ...
             */
            for (int i = 1; i <= 10; i++) {
                channel.basicPublish("test_fanout", "", null, (i+"hello rabbitMQ").getBytes("UTF-8"));
            }
